...
$mail->Username   = 'sales@arisesolarllc.com';       // SMTP username
$mail->Password   = "Arise@SGBSYPM.2210";                           // SMTP password
...
//Recipients
$mail->setFrom('sales@arisesolarllc.com', 'Contact Us');
...
$sql = "INSERT INTO `resha_by_mirika` (`name`,  `email`, `subject`, `message`) VALUES
 ('$form_name', '$contact_email', '$contact_subject', '$contact_message');";
																		...
																		<td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
																		   ...
																		   Dear <b>' . $form_name . '</b><br>
																			  ...
																			  <ul>
																				 ...
																				 <li><strong>Subject</strong> - ' . $contact_subject . '</li>
