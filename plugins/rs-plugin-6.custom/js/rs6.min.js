  ...
  var a = i.is_mobile(),
      ...
      if (i[r] !== t) {
        ...
        i[r].slides))
          if (i[r].slides.hasOwnProperty(d) && "length" !== d) {
            ...
            (h = 0 === h.length ? c.getElementsByTagName("img")[0] : h),
              i.gA(c, "key") === t &&
                i.sA(c, "key", "rs-" + Math.round(999999 * Math.random()));
            var v = {
              params: Array(12),
              id: i.gA(c, "key"),
              src: i.gA(c, "thumb") !== t ? i.gA(c, "thumb") : u(h, h.src, r),
            };
            i.gA(c, "title") === t && i.sA(c, "title", ""),
              i.gA(c, "description") === t && i.sA(c, "description", ""),
              (v.params[0] = {
                from: RegExp("\\{\\{title\\}\\}", "g"),
                to: i.gA(c, "title"),
              }),
            ...
            if (
              ((i[r].thumbs[d] = v),
              i.gA(c, "link") != t || i.gA(c, "linktoslide") !== t)
            ) {
              var w = i.gA(c, "link") !== t ? i.gA(c, "link") : "slide",
                _ = "slide" != w ? "no" : i.gA(c, "linktoslide"),
                x = i.gA(c, "seoz");
              if (_ != t && "no" != _ && "next" != _ && "prev" != _)
                for (var k in i[r].slides)
                  i[r].slides.hasOwnProperty(k) &&
                    parseInt(i.gA(i[r].slides[k], "origindex"), 0) + 1 ==
                      i.gA(c, "linktoslide") &&
                    (_ = i.gA(i[r].slides[k], "key"));
              e(c).append(
        ...
        if (
          ...
          i[r].c[0].classList.add("revslider-initialised"),
            ...
            i[r].rs_static_layer.length > 0 &&
              ...
              A(i[r].rs_static_layer[0], r, function () {
                i[r] !== t &&
          ...
          if (
            ...
            e.isNumeric(parseInt(S, 0)) &&
              ((S = parseInt(S, 0)) < 1 && (S = 1),
              S > i[r].slideamount && (S = i[r].slideamount),
              (i[r].startWithSlide = S - 1));
          }
          ...
          var M = i[r].viewPort;
          (i[r].inviewport = !1),
            M != t && M.enable && i.scrollTicker && i.scrollTicker(r),
            i[r].slides.each(function (t) {
              ...
              (i[r].rowzones[t] = []),
                ...
                ((((M.enable && i[r].inviewport) || !M.enable) &&
                  "all" == i[r].lazyType) ||
                  ("smart" == i[r].lazyType &&
                    (0 == t ||
                      1 == t ||
            ...
            setTimeout(function () {
              !M.enable ||
              (M.enable && i[r].inviewport) ||
              (M.enable && !i[r].inviewport && "wait" !== M.outof)
                ? O(r)
                : (i[r].c.addClass("tp-waitforfirststart"),
                  ...
                  M.presize &&
                    ...
                    A(i[r].pr_next_slide.find(".tp-layers"), r, function () {
                      i.animateTheLayers &&
                        i.animateTheLayers({
                ...
                i[r].slideamount > 1 &&
                  (!M.enable || (M.enable && i[r].inviewport)
                    ? j(r)
    ...
    b = function (a) {
      ...
      for (var r = 0; r < i[a].slides.length; r++) {
        ...
        l.append('<canvas class="bgcanvas"></canvas>'),
          (c.src = s[0].src),
    ...
    A = function (r, o, s) {
      if (r !== t && 0 !== r.length && i[o] !== t) {
          ...
          if (
            ...
            if (
              ...
              if (((l[d].src = g.src), "img" == g.type)) {
                if (c.slidebgimage) {
                  (-1 == g.src.indexOf("assets/images/transparent.png") &&
        ...
        !a &&
          ...
          n
            ? punchgs.TweenMax.delayedCall(0.18, A, [r, o, s])
      ...
      if (i[a] !== t)
        if (
          ...
          !0 === i[a].onlyPreparedSlide && (i[a].onlyPreparedSlide = !1),
            ...
            A(i[a].pr_next_slide[0], a, function () {
              i[a] !== t &&
            ...
            if (
              ...
              if (o.vary_fade)
                h.autoAlpha =
                  1 -
                  Math.abs(
                    (o.maxOpacity / 100 / Math.ceil(o.maxVisibleItems / f)) * g
                  );
              else
                switch (o.horizontal_align) {
                  case "center":
                    h.autoAlpha =
                      Math.abs(g) < Math.ceil(o.maxVisibleItems / f - 1)
                        ? 1
                        : 1 - (Math.abs(g) - Math.floor(Math.abs(g)));
                    break;
                  case "left":
                    h.autoAlpha =
                      g < 1 && g > 0
                        ? 1 - g
                        : Math.abs(g) > o.maxVisibleItems - 1
                        ? 1 - (Math.abs(g) - (o.maxVisibleItems - 1))
                        : 1;
                    break;
                  case "right":
                    h.autoAlpha =
            ...
            void 0 !== o.minScale &&
              ...
              (o.vary_scale
                ? (h.scale =
                    1 -
                    Math.abs(
                      (o.minScale / 100 / Math.ceil(o.maxVisibleItems / f)) * g
                    ))
                : (h.scale =
                    g >= 1 || g <= -1
                      ? 1 - o.minScale / 100
                      : (100 - o.minScale * Math.abs(g)) / 100),
              (p =
                (p = (g * (h.width - h.width * h.scale)) / 2) > 300 ? 300 : p)),
        ...
        i[o].layers[s]))
          if (i[o].layers[s].hasOwnProperty(n)) {
            ...
            if (void 0 === i.gA(c, "initialised")) {
              ...
              if (
                (void 0 !== g.spike && (g.spike = I(g.spike)),
                void 0 !== g.corners)
              )
              ...
              if (
                  ...
                  var L =
                    ...
                    A =
                      ...
                      (isNaN(g.height[i[o].level]) &&
                        ...
                        ? "100%"
                        : "auto";
                  punchgs.TweenMax.set(g.img, { width: L, height: A });
                }
                ...
                (z =
                  ...
                  (M =
                    "auto" === M
                      ? M
                      : !jQuery.isNumeric(M) && M.indexOf("%") > 0
                      ? "grid" === g.basealign
                        ? i[o].gridheight[i[o].level] * i[o].bw
                        : v
                      : "off" !== g.rsp_bd
                      ? parseFloat(M) * i[o].bh + "px"
                      : parseFloat(M) + "px");
                var O = T(h, o);
                if (
                  g._incolumn &&
                  ...
                  -1 != h[0].className.indexOf("rs-fsv") || S
                    ? ((l = 0),
                      (d = 0),
                    ...
                    ((0 == g.html5vid && !S) ||
                      (1 != g.forcecover && !h.hasClass("rs-fsv") && !S)) &&
                      (g.media.width(z), g.media.height(M)),
                    g._ingroup &&
                      null != z &&
                      !jQuery.isNumeric(z) &&
                      z.indexOf("%") > 0 &&
              ...
              if ("frame_0" !== I && "frame_hover" !== I && "loop" !== I) {
                ...
                if (
                  ...
                  if (void 0 !== u.splitText && !1 !== u.splitText)
                    for (var Y in t)
                      if (void 0 === S[t[Y]] || u.quickRendering)
                        u.fff
                          ? M.add(
                              O.fromTo(
                                u.splitText[t[Y]],
                          ...
                          : M.add(
                              O.to(u.splitText[t[Y]], j, { color: H.color }, 0),
                              0
                            );
                      else {
                        ...
                        delete Z.dir,
                          ...
                          (V = F.length > V ? F.length : V);
                      }
                  (j += u.frames[I].split ? Q * V : 0),
                    u.pxundermask ||
                    (void 0 !== B &&
                    ...
                    u.fff
                      ? ((H.visibility = "visible"),
                        void 0 !== u.cbg && M.fromTo(u.cbg, j, N, H, 0),
                        ...
                        void 0 !== u.cbg && "column" === u.type
                          ? M.fromTo(C, j, a(N), a(H), 0)
                          : M.fromTo(C, j, N, H, 0))
                      : (void 0 !== u.cbg && M.to(u.cbg, j, H, 0),
                        !i[c].BUG_safari_clipPath ||
                          (!H.clipPath && !u.spike) ||
                          (H.z && parseInt(H.z, 10)) ||
                  ...
                  u.timeline.addLabel(I, G),
                    ...
                    M.eventCallback("onStart", o, [{ id: c, frame: I, L: d }]),
                    "true" == u.animationonscroll || 1 == u.animationonscroll
                      ? (M.eventCallback("onUpdate", s, [
                          { id: c, frame: I, L: d },
                        ]),
                        (M.smoothChildTiming = !0))
                      : M.eventCallback("onUpdate", s, [
                          { id: c, frame: I, L: d },
                        ]),
          ...
          if (
            ...
            if (
              ...
              if (void 0 === u.childrenJS)
                for (var Y in ((u.childrenJS = {}), i[c]._L))
                  void 0 !== i[c]._L[Y]._lig &&
                    void 0 !== i[c]._L[Y]._lig[0] &&
                    i[c]._L[Y]._lig[0].id === d[0].id &&
                    i[c]._L[Y]._lig[0].id !== i[c]._L[Y].c[0].id &&
                    (u.childrenJS[i[c]._L[Y].c[0].id] = i[c]._L[Y].c);
              var ue =
                void 0 === e.totime
                  ? void 0 !== u.frames[e.frame].timeline.startAbsolute
                    ...
                    : 0.001
                  : e.totime;
              for (var Y in u.childrenJS)
                u.childrenJS.hasOwnProperty(Y) &&
                  i.renderLayerAnimation({
        ...
        if (
          ...
          if (
            ...
            o._isnotext ||
              ...
              p.textStroke && (f["-webkit-text-stroke"] = p.textStroke)),
            "column" === o.type &&
              (void 0 === o.cbg_set &&
                ...
                switch (s) {
                  ...
                  case "move":
                    ...
                    M =
                      (M = z + c) > 0
                        ? "horizontal" === R
                          ? M - L.width() * (((M / L.width()) * M) / L.width())
                          : M -
                            L.height() * (((M / L.height()) * M) / L.height())
                        : M;
                    var O =
                      "vertical" === R
                        ? 0 - (L.height() - T.height())
                    ...
                    (M =
                      M < O
                        ? "horizontal" === R
                          ? M +
                            (((L.width() * (M - O)) / L.width()) * (M - O)) /
                              L.width()
                          : M +
                            (((L.height() * (M - O)) / L.height()) * (M - O)) /
                              L.height()
                        : M),
                      "vertical" === R
                        ? punchgs.TweenLite.set(L, { top: M + "px" })
                        : punchgs.TweenLite.set(L, { left: M + "px" });
                    break;
                  case "end":
                  case "cancel":
                    if (v)
            ...
            case 12:
              ...
              t[a].mtl.add(
                punchgs.TweenLite.fromTo(
                  t[a].pr_next_bg,
                  p / 1e3,
                  { autoAlpha: 0, filter: M, "-webkit-filter": M },
                  {
                    autoAlpha: 1,
                    filter: O,
                    "-webkit-filter": O,
                ...
                jQuery.inArray(l.trC, [6, 8, 10]) >= 0 &&
                  t[a].mtl.add(
                    punchgs.TweenLite.fromTo(
                      t[a].pr_active_bg,
                      p / 1e3,
                      { autoAlpha: 1, filter: O, "-webkit-filter": O },
                      {
                        autoAlpha: 0,
                        force3D: "auto",
                        ease: g,
